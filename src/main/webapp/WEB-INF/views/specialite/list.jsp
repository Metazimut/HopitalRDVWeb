...
<body>
	<div class="container-fluid">
		<div class="card mt-3">
			...
			<div class="card-body">
				<table id="specialiteTable" class="table table-striped">
					<thead>
						<tr>
							<th>Identifiant</th>
							<th>Libelle</th>
					...
					<tbody>
						<c:forEach items="${mesSpecialites}" var="spe">
							<c:url value="/specialite/edit" var="editUrl">
								<c:param name="id" value="${spe.id}"/>
							</c:url>
							<c:url value="/specialite/delete" var="deleteUrl">
								<c:param name="id" value="${spe.id}"/>
							</c:url>
							<tr>
								<td>${spe.id}</td>
			...
			<c:url value="specialite/add" var="addUrl"/>
